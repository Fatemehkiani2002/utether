...
const Page: PageEl = (props, state, refresh, getProps) => {
  ...
  return (
    <div style={{ direction: "rtl", minHeight: "11vh", borderRadius: 0 }}>
      ...
      {" "}
      <Window
        title={"قیمت لحظه ای تتر:"}
        style={{ minHeight: 200, margin: 10, width: "calc(100% - 10px)", height:400,
      ...
      >
        ...
        >
           <br-x />
           <br-xx />
           تغییرات در ۱ ماه گذشته: ٪{" "}
          {(Number(props.p.diff30d) as number).toLocaleString("fa-IR")}
          {" "}
        </div>
         <br-xx />
         {" "}
        <center style={{ fontSize: 11 }}>victory team </center>
         <br-xx />
         {" "}
      </Window>
      {" "}
